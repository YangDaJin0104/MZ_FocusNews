...
public class ChatGPTAPI {
    ...
    public static String chatGPT(String summarize1, String summarize2, String summarize3) {
        ...
        try {
            ...
            // prompt 생성
            String prompt = summarize1 + summarize2 + summarize3 + "위 내용을 바탕으로 객관식 문제를 새로 만들어줘. 문제 내용, 정답, 선택지1, 선택지2, 선택지3, 선택지4를 question, answer, option1, option2, option3, option4 Json 형태로 보내줘";
